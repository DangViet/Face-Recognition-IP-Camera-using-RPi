...
import base64
key = base64.b64encode('test:test') 
class CamHandler(BaseHTTPRequestHandler):
    ...
    def do_AUTHHEAD(self):
        ...
        self.send_header('WWW-Authenticate', 'Basic realm=\"Enter Usernam and Password\"')
        self.send_header('Content-type', 'text/html')
        self.end_headers()
    ...
    def do_GET(self):
        if self.headers.getheader('Authorization') == None:
            ...
            if self.path.endswith('.html'):
                ...
                self.wfile.write("<html><head><title>IP CAMERA</title></head>")
                self.wfile.write("<body><p><b>      Raspberry Pi-based IP Camera</b></p>")
